...
func regFuncs() {
	...
	// TODO: check sym is func, and accepts the following two params
...
func replaceWithRuntimeCall(fn *ir.Func, name string) {
	...
	node = ir.NewIfStmt(base.AutogeneratedPos,
		...
		[]ir.Node{
			...
			// 	ir.NewBasicLit(base.AutogeneratedPos, types.Types[types.TSTRING], constant.MakeString("shit panic")),
			// }),
			callNode,
		},
		fn.Body,
