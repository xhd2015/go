...
var runtimeDecls = [...]struct {
	...
	{"cmpstring", funcTag, 42},
	{"intstring", funcTag, 45},
	{"slicebytetostring", funcTag, 46},
	{"slicebytetostringtmp", funcTag, 47},
	{"slicerunetostring", funcTag, 50},
	{"stringtoslicebyte", funcTag, 52},
	{"stringtoslicerune", funcTag, 55},
	{"slicecopy", funcTag, 56},
	{"decoderune", funcTag, 57},
	{"countrunes", funcTag, 58},
	{"convT", funcTag, 59},
...
func runtimeTypes() []*types.Type {
	...
	typs[42] = newSig(params(typs[28], typs[28]), params(typs[15]))
	typs[43] = types.NewArray(typs[0], 4)
	typs[44] = types.NewPtr(typs[43])
	typs[45] = newSig(params(typs[44], typs[22]), params(typs[28]))
	typs[46] = newSig(params(typs[35], typs[1], typs[15]), params(typs[28]))
	typs[47] = newSig(params(typs[1], typs[15]), params(typs[28]))
	typs[48] = types.RuneType
	typs[49] = types.NewSlice(typs[48])
	typs[50] = newSig(params(typs[35], typs[49]), params(typs[28]))
	typs[51] = types.NewSlice(typs[0])
	typs[52] = newSig(params(typs[35], typs[28]), params(typs[51]))
	typs[53] = types.NewArray(typs[48], 32)
	typs[54] = types.NewPtr(typs[53])
	typs[55] = newSig(params(typs[54], typs[28]), params(typs[49]))
	typs[56] = newSig(params(typs[3], typs[15], typs[3], typs[15], typs[5]), params(typs[15]))
	typs[57] = newSig(params(typs[28], typs[15]), params(typs[48], typs[15]))
	typs[58] = newSig(params(typs[28]), params(typs[15]))
	...
	typs[73] = types.NewPtr(typs[5])
	typs[74] = newSig(params(typs[73], typs[7], typs[7]), params(typs[6]))
	...
	typs[113] = newSig(params(typs[73]), nil)
	typs[114] = newSig(params(typs[1], typs[1], typs[73], typs[15], typs[15], typs[6]), params(typs[15], typs[6]))
